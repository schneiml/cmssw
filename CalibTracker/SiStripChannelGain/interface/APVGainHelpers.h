...
namespace APVGain {
  ...
  public:
    ...
    std::array< std::vector<MonitorElement*>,7 > Charge_1;   /*!< Charge per cm per layer / wheel */
    std::array< std::vector<MonitorElement*>,7 > Charge_2;   /*!< Charge per cm per layer / wheel without G2 */
    std::array< std::vector<MonitorElement*>,7 > Charge_3;   /*!< Charge per cm per layer / wheel without G1 */
    std::array< std::vector<MonitorElement*>,7 > Charge_4;   /*!< Charge per cm per layer / wheel without G1 and G1*/
