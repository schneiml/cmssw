...
//
void DQMExample_Step1::dqmEndLuminosityBlock(edm::LuminosityBlock const& lumiSeg, edm::EventSetup const& eSetup) 
{
  edm::LogInfo("DQMExample_Step1") <<  "DQMExample_Step1::dqmEndLuminosityBlock" << std::endl;
}
