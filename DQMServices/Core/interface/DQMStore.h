...
public:
  ...
  /* almost unused */ void Fill(char x) {
...
public:
  ...
  /* almost unused */ void setTitle(std::string const& title) { me_->setTitle(title); }

  /* almost unused */ void setXTitle(std::string const& title) { me_->getTH1()->SetXTitle(title.c_str()); }

  void setXTitle(const char* title) { me_->getTH1()->SetXTitle(title); }

  /* almost unused */ void setYTitle(std::string const& title) { me_->getTH1()->SetYTitle(title.c_str()); }
