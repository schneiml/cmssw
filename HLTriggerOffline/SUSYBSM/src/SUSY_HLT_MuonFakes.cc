...
void SUSY_HLT_MuonFakes::dqmEndLuminosityBlock(edm::LuminosityBlock const& lumiSeg, edm::EventSetup const& eSetup)
{
  edm::LogInfo("SUSY_HLT_MuonFakes") << "SUSY_HLT_MuonFakes::dqmEndLuminosityBlock" << std::endl;
}
