...
void SUSY_HLT_VBF_Mu::dqmEndLuminosityBlock(edm::LuminosityBlock const& lumiSeg, edm::EventSetup const& eSetup)
{
    edm::LogInfo("SUSY_HLT_VBF_Mu") << "SUSY_HLT_VBF_Mu::dqmEndLuminosityBlock" << std::endl;
}
