...
SUSY_HLT_PhotonMET_pt36 = DQMStep1Analyzer("SUSY_HLT_PhotonMET",
...
SUSY_HLT_PhotonMET_pt50 = DQMStep1Analyzer("SUSY_HLT_PhotonMET",
   trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'),
   pfMETCollection = cms.InputTag("pfMet"),
   photonCollection = cms.InputTag("gedPhotons"),
   TriggerResults = cms.InputTag('TriggerResults','','HLT'),
...
SUSY_HLT_PhotonMET_pt75 = DQMStep1Analyzer("SUSY_HLT_PhotonMET",
   trigSummary = cms.InputTag("hltTriggerSummaryAOD",'', 'HLT'),
   pfMETCollection = cms.InputTag("pfMet"),
   photonCollection = cms.InputTag("gedPhotons"),
   TriggerResults = cms.InputTag('TriggerResults','','HLT'),
