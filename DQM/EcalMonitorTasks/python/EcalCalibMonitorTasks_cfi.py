...
ecalPedestalMonitorTask = DQMStep1Analyzer("EcalDQMonitorTask",
...
ecalTestPulseMonitorTask = DQMStep1Analyzer("EcalDQMonitorTask",
...
ecalLaserLedMonitorTask = DQMStep1Analyzer("EcalDQMonitorTask",
...
ecalPNDiodeMonitorTask = DQMStep1Analyzer("EcalDQMonitorTask",
