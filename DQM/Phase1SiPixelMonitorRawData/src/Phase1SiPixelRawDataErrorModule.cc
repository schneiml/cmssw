#include "DQM/Phase1SiPixelMonitorRawData/interface/Phase1SiPixelRawDataErrorModule.h"
...
const int Phase1SiPixelRawDataErrorModule::LINK_bits = 6;
const int Phase1SiPixelRawDataErrorModule::ROC_bits  = 5;
const int Phase1SiPixelRawDataErrorModule::DCOL_bits = 5;
const int Phase1SiPixelRawDataErrorModule::PXID_bits = 8;
const int Phase1SiPixelRawDataErrorModule::ADC_bits  = 8;
const int Phase1SiPixelRawDataErrorModule::DataBit_bits = 1;
 
const int Phase1SiPixelRawDataErrorModule::ADC_shift  = 0;
const int Phase1SiPixelRawDataErrorModule::PXID_shift = ADC_shift + ADC_bits;
const int Phase1SiPixelRawDataErrorModule::DCOL_shift = PXID_shift + PXID_bits;
const int Phase1SiPixelRawDataErrorModule::ROC_shift  = DCOL_shift + DCOL_bits;
const int Phase1SiPixelRawDataErrorModule::LINK_shift = ROC_shift + ROC_bits;
const int Phase1SiPixelRawDataErrorModule::DB0_shift = 0;
const int Phase1SiPixelRawDataErrorModule::DB1_shift = DB0_shift + DataBit_bits;
const int Phase1SiPixelRawDataErrorModule::DB2_shift = DB1_shift + DataBit_bits;
const int Phase1SiPixelRawDataErrorModule::DB3_shift = DB2_shift + DataBit_bits;
const int Phase1SiPixelRawDataErrorModule::DB4_shift = DB3_shift + DataBit_bits;
const int Phase1SiPixelRawDataErrorModule::DB5_shift = DB4_shift + DataBit_bits;
const int Phase1SiPixelRawDataErrorModule::DB6_shift = DB5_shift + DataBit_bits;
const int Phase1SiPixelRawDataErrorModule::DB7_shift = DB6_shift + DataBit_bits;
 
const uint32_t Phase1SiPixelRawDataErrorModule::LINK_mask = ~(~uint32_t(0) << LINK_bits);
const uint32_t Phase1SiPixelRawDataErrorModule::ROC_mask  = ~(~uint32_t(0) << ROC_bits);
const uint32_t Phase1SiPixelRawDataErrorModule::DCOL_mask = ~(~uint32_t(0) << DCOL_bits);
const uint32_t Phase1SiPixelRawDataErrorModule::PXID_mask = ~(~uint32_t(0) << PXID_bits);
const uint32_t Phase1SiPixelRawDataErrorModule::ADC_mask  = ~(~uint32_t(0) << ADC_bits);
const uint32_t Phase1SiPixelRawDataErrorModule::DataBit_mask = ~(~uint32_t(0) << DataBit_bits);
 
const int Phase1SiPixelRawDataErrorModule::TRLRBGN_bits = 32;
const int Phase1SiPixelRawDataErrorModule::EVTLGT_bits  = 24;
const int Phase1SiPixelRawDataErrorModule::TRLREND_bits = 8;
 
const int Phase1SiPixelRawDataErrorModule::TRLRBGN_shift = 0;
const int Phase1SiPixelRawDataErrorModule::EVTLGT_shift  = TRLRBGN_shift + TRLRBGN_bits;
const int Phase1SiPixelRawDataErrorModule::TRLREND_shift = EVTLGT_shift + EVTLGT_bits;
 
const long long Phase1SiPixelRawDataErrorModule::TRLREND_mask = ~(~(long long)(0) << TRLREND_bits);
const long long Phase1SiPixelRawDataErrorModule::EVTLGT_mask  = ~(~(long long)(0) << EVTLGT_bits);
const long long Phase1SiPixelRawDataErrorModule::TRLRBGN_mask = ~(~(long long)(0) << TRLRBGN_bits);
//
// Constructors
//
Phase1SiPixelRawDataErrorModule::Phase1SiPixelRawDataErrorModule() : 
  id_(0),
  ncols_(416),
  nrows_(160) 
{ 
...
//
Phase1SiPixelRawDataErrorModule::Phase1SiPixelRawDataErrorModule(const uint32_t& id) : 
  id_(id),
  ncols_(416),
  nrows_(160)
{ 
...
//
Phase1SiPixelRawDataErrorModule::Phase1SiPixelRawDataErrorModule(const uint32_t& id, const int& ncols, const int& nrows) : 
  id_(id),
  ncols_(ncols),
  nrows_(nrows)
{ 
...
//
void Phase1SiPixelRawDataErrorModule::book(const edm::ParameterSet& iConfig, DQMStore::IBooker & iBooker, int type, bool isUpgrade) {}
//
// Fill histograms
//
int Phase1SiPixelRawDataErrorModule::fill(const edm::DetSetVector<SiPixelRawDataError>& input, std::map<std::string,MonitorElement**> *meMapFEDs, bool modon, bool ladon, bool bladeon) {
...
int Phase1SiPixelRawDataErrorModule::fillFED(const edm::DetSetVector<SiPixelRawDataError>& input, std::map<std::string,MonitorElement**> *meMapFEDs) {
  unsigned int numberOfSeriousErrors = 0;
