#ifndef Phase1SiPixelMonitorRawData_SiPixelRawDataErrorSource_h
#define Phase1SiPixelMonitorRawData_SiPixelRawDataErrorSource_h
// -*- C++ -*-
//
...
#include <boost/cstdint.hpp>
 ...
 class Phase1SiPixelRawDataErrorSource : public DQMEDAnalyzer {
    public:
       explicit Phase1SiPixelRawDataErrorSource(const edm::ParameterSet& conf);
       ~Phase1SiPixelRawDataErrorSource();
    ...
    private:
       ...
       bool isUpgrade;
       int eventNo;
       std::map<uint32_t,Phase1SiPixelRawDataErrorModule*> thePixelStructure;
       std::map<uint32_t,Phase1SiPixelRawDataErrorModule*> theFEDStructure;
       bool firstRun;
