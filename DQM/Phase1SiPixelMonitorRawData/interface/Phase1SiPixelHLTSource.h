#ifndef Phase1SiPixelMonitorRawData_SiPixelHLTSource_h
#define Phase1SiPixelMonitorRawData_SiPixelHLTSource_h
// -*- C++ -*-
//
...
#include "DataFormats/SiPixelRawData/interface/Phase1SiPixelRawDataError.h"
