#ifndef Phase1SiPixelMonitorRawData_SiPixelRawDataErrorModule_h
#define Phase1SiPixelMonitorRawData_SiPixelRawDataErrorModule_h
// -*- C++ -*-
//
// Package:    Phase1SiPixelMonitorRawData
// Class:      Phase1SiPixelRawDataErrorModule
// 
/**\class 
...
class Phase1SiPixelRawDataErrorModule {        
 ...
 public:
  ...
  /// Default constructor
  Phase1SiPixelRawDataErrorModule();
  /// Constructor with raw DetId
  Phase1SiPixelRawDataErrorModule(const uint32_t& id);
  /// Constructor with raw DetId and sensor size
  Phase1SiPixelRawDataErrorModule(const uint32_t& id, const int& ncols, const int& nrows);
  /// Destructor
  ~Phase1SiPixelRawDataErrorModule();
