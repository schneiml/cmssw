...
V0Monitor::MonitorElement* V0Monitor::bookHisto1D(DQMStore::IBooker & ibooker,std::string name, std::string title, std::string xaxis, std::string yaxis, MEbinning binning)
{
...
V0Monitor::MonitorElement* V0Monitor::bookHisto2D(DQMStore::IBooker & ibooker,std::string name, std::string title, std::string xaxis, std::string yaxis, MEbinning xbinning, MEbinning ybinning)
{
  std::string title_w_axes = title+";"+xaxis+";"+yaxis;
...
V0Monitor::MonitorElement* V0Monitor::bookProfile(DQMStore::IBooker & ibooker,std::string name, std::string title, std::string xaxis, std::string yaxis, MEbinning xbinning, MEbinning ybinning)
{
  std::string title_w_axes = title+";"+xaxis+";"+yaxis;
