...
singleTopTChannelLeptonDQM = DQMStep1Analyzer("SingleTopTChannelLeptonDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
...
singleTopMuonMediumDQM = DQMStep1Analyzer("SingleTopTChannelLeptonDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
  ## configuration of the MonitoringEnsemble(s)
...
singleTopElectronMediumDQM = DQMStep1Analyzer("SingleTopTChannelLeptonDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
  ## configuration of the MonitoringEnsemble(s)
