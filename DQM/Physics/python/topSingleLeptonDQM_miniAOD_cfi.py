...
topSingleLeptonDQM_miniAOD = DQMStep1Analyzer("TopSingleLeptonDQM_miniAOD",
  setup = cms.PSet(
...
topSingleMuonLooseDQM_miniAOD = DQMStep1Analyzer("TopSingleLeptonDQM_miniAOD",
...
topSingleMuonMediumDQM_miniAOD = DQMStep1Analyzer("TopSingleLeptonDQM_miniAOD",
  setup = cms.PSet(
...
topSingleElectronLooseDQM_miniAOD = DQMStep1Analyzer("TopSingleLeptonDQM_miniAOD",
  setup = cms.PSet(
...
topSingleElectronMediumDQM_miniAOD = DQMStep1Analyzer("TopSingleLeptonDQM_miniAOD",
  setup = cms.PSet(
