...
void OuterTrackerMCHarvester::dqmEndJob(DQMStore::IBooker & ibooker, DQMStore::IGetter & igetter) {
	...
	if (dqmstore_) {
		...
		MonitorElement *merespt_eta0to0p7_pt2to3 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta0to0p7_pt2to3");
		MonitorElement *merespt_eta0p7to1_pt2to3 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta0p7to1_pt2to3");
		MonitorElement *merespt_eta1to1p2_pt2to3 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1to1p2_pt2to3");
		MonitorElement *merespt_eta1p2to1p6_pt2to3 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1p2to1p6_pt2to3");
		MonitorElement *merespt_eta1p6to2_pt2to3 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1p6to2_pt2to3");
		MonitorElement *merespt_eta2to2p4_pt2to3 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta2to2p4_pt2to3");
		MonitorElement *merespt_eta0to0p7_pt3to8 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta0to0p7_pt3to8");
		MonitorElement *merespt_eta0p7to1_pt3to8 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta0p7to1_pt3to8");
		MonitorElement *merespt_eta1to1p2_pt3to8 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1to1p2_pt3to8");
		MonitorElement *merespt_eta1p2to1p6_pt3to8 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1p2to1p6_pt3to8");
		MonitorElement *merespt_eta1p6to2_pt3to8 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1p6to2_pt3to8");
		MonitorElement *merespt_eta2to2p4_pt3to8 = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta2to2p4_pt3to8");
		MonitorElement *merespt_eta0to0p7_pt8toInf = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta0to0p7_pt8toInf");
		MonitorElement *merespt_eta0p7to1_pt8toInf = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta0p7to1_pt8toInf");
		MonitorElement *merespt_eta1to1p2_pt8toInf = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1to1p2_pt8toInf");
		MonitorElement *merespt_eta1p2to1p6_pt8toInf = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1p2to1p6_pt8toInf");
		MonitorElement *merespt_eta1p6to2_pt8toInf = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta1p6to2_pt8toInf");
		MonitorElement *merespt_eta2to2p4_pt8toInf = dqmstore_->get("SiOuterTrackerV/Tracks/Resolution/respt_eta2to2p4_pt8toInf");
