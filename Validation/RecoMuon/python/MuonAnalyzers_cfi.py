...
STAMuonAnalyzer = DQMStep1Analyzer("MuonTrackAnalyzer",
...
GLBMuonAnalyzer = DQMStep1Analyzer("MuonTrackAnalyzer",
    MuonTrackAnalysisParameters,
    Tracks = cms.InputTag("globalMuons"),
    dirName = cms.untracked.string('Muons/RecoMuonV/TrackAnalyzer/')
)

TrackerMuonAnalyzer = DQMStep1Analyzer("MuonTrackAnalyzer",
    MuonTrackAnalysisParameters,
    Tracks = cms.InputTag("generalTracks"),
    dirName = cms.untracked.string('Muons/RecoMuonV/TrackAnalyzer/')
)

MuonTrackResidualAnalyzer = DQMStep1Analyzer("MuonTrackResidualAnalyzer",
    MuonTrackAnalysisParameters,
