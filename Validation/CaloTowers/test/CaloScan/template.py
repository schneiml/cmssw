...
process.HcalSimHitsAnalyser = DQMStep1Analyzer("HcalSimHitsValidation",
    outputFile = cms.untracked.string('HcalSimHitsValidation.root')
)   

process.hcalDigiAnalyzer = DQMStep1Analyzer("HcalDigisValidation",
...
process.hcalRecoAnalyzer = DQMStep1Analyzer("HcalRecHitsValidation",
...
process.hcalTowerAnalyzer = DQMStep1Analyzer("CaloTowersValidation",
