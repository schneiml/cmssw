...
struct MTVHistoProducerAlgoForTrackerHistograms {
  ...
  std::vector<dqm::reco::MonitorElement const*> h_recochi2prob, h_assoc2chi2prob, h_looperchi2prob, h_misidchi2prob,
      h_pileupchi2prob;
  std::vector<dqm::reco::MonitorElement const*> h_pt, h_eta, h_pullTheta, h_pullPhi, h_pullDxy, h_pullDz, h_pullQoverp;
  std::vector<dqm::reco::MonitorElement const*> h_assoc2_itpu_eta, h_assoc2_itpu_sig_eta, h_assoc2eta_sig;
  std::vector<dqm::reco::MonitorElement const*> h_assoc2_itpu_vertcount, h_assoc2_itpu_sig_vertcount;
  std::vector<dqm::reco::MonitorElement const*> h_assoc2_ootpu_eta, h_assoc2_ootpu_vertcount;
  std::vector<dqm::reco::MonitorElement const*> h_reco_ootpu_eta, h_reco_ootpu_vertcount;
  std::vector<dqm::reco::MonitorElement const*> h_con_eta, h_con_vertcount, h_con_zpos;
  ...
  std::vector<std::vector<dqm::reco::MonitorElement const*>> h_dedx_estim;
  std::vector<std::vector<dqm::reco::MonitorElement const*>> h_dedx_nom;
  std::vector<std::vector<dqm::reco::MonitorElement const*>> h_dedx_sat;

  //2D
  std::vector<dqm::reco::MonitorElement const*> nrec_vs_nsim;
  std::vector<dqm::reco::MonitorElement const*> nrecHit_vs_nsimHit_sim2rec;
  std::vector<dqm::reco::MonitorElement const*> nrecHit_vs_nsimHit_rec2sim;
  std::vector<dqm::reco::MonitorElement const*> h_duplicates_oriAlgo_vs_oriAlgo;

  //assoc hits
  std::vector<dqm::reco::MonitorElement const*> h_assocFraction, h_assocSharedHit;

  //#hit vs eta: to be used with doProfileX
  std::vector<dqm::reco::MonitorElement const*> nhits_vs_eta, nPXBhits_vs_eta, nPXFhits_vs_eta, nPXLhits_vs_eta,
  ...
  std::vector<dqm::reco::MonitorElement const*> h_ptshifteta;
  std::vector<dqm::reco::MonitorElement const*> ptres_vs_phi, chi2_vs_phi, nhits_vs_phi, phires_vs_phi;

  //Profile2D
  std::vector<dqm::reco::MonitorElement const*> ptmean_vs_eta_phi, phimean_vs_eta_phi;

  //assoc chi2
  std::vector<dqm::reco::MonitorElement const*> h_assochi2, h_assochi2_prob;

  //chi2 and # lost hits vs eta: to be used with doProfileX
  std::vector<dqm::reco::MonitorElement const*> chi2_vs_eta, nlosthits_vs_eta;
