...
JetAnalyzerICPU5Calo = DQMStep1Analyzer("JetTester_HeavyIons",
...
'''
JetAnalyzerICPU7Calo = DQMStep1Analyzer("JetTester_HeavyIons",
                                      JetType = cms.untracked.string('calo'),                       
                                      UEAlgo = cms.untracked.string('Pu'),                                    
                                      OutputFile = cms.untracked.string(''),
...
'''
JetAnalyzerAkPU3Calo = DQMStep1Analyzer("JetTester_HeavyIons",
                                      JetType = cms.untracked.string('calo'),
                                      UEAlgo = cms.untracked.string('Pu'),
                                      OutputFile = cms.untracked.string(''),
...
JetAnalyzerAkPU4Calo = DQMStep1Analyzer("JetTester_HeavyIons",
                                      JetType = cms.untracked.string('calo'),
                                      UEAlgo = cms.untracked.string('Pu'),
                                      OutputFile = cms.untracked.string(''),
...
JetAnalyzerAkPU5Calo = DQMStep1Analyzer("JetTester_HeavyIons",
                                      JetType = cms.untracked.string('calo'),
                                      UEAlgo = cms.untracked.string('Pu'),
                                      OutputFile = cms.untracked.string(''),
...
JetAnalyzerAkPU3PF = DQMStep1Analyzer("JetTester_HeavyIons",
...
JetAnalyzerAkPU4PF = DQMStep1Analyzer("JetTester_HeavyIons",
                                    JetType = cms.untracked.string('pf'),
                                    UEAlgo = cms.untracked.string('Pu'),
                                    OutputFile = cms.untracked.string(''),
...
JetAnalyzerAkPU5PF = DQMStep1Analyzer("JetTester_HeavyIons",
                                    JetType = cms.untracked.string('pf'),
                                    UEAlgo = cms.untracked.string('Pu'),
                                    OutputFile = cms.untracked.string(''),
