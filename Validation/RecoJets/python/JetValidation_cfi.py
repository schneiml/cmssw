...
### kt6 PF jets - UnCorr
###-------------------------------------------------------------------------------
#JetAnalyzerKt6PF = DQMStep1Analyzer("JetTester",
...
##-------------------------------------------------------------------------------
#JetAnalyzerKt6Calo = DQMStep1Analyzer("JetTester",
#                                    JetType = cms.untracked.string('calo'),
#                                    OutputFile = cms.untracked.string(''),
...
# AntiKt5 Calo jets
#-------------------------------------------------------------------------------
JetAnalyzerAk4Calo = DQMStep1Analyzer("JetTester",
                                    JetType = cms.untracked.string('calo'),
...
## AntiKt7 Calo jets
##-------------------------------------------------------------------------------
#JetAnalyzerAk7Calo = DQMStep1Analyzer("JetTester",
#                                    JetType = cms.untracked.string('calo'),
#                                    OutputFile = cms.untracked.string(''),
...
# AntiKt5 PF jets
#-------------------------------------------------------------------------------
JetAnalyzerAk4PF = DQMStep1Analyzer("JetTester",
...
# AntiKt5 JPT jets
#-------------------------------------------------------------------------------
#JetAnalyzerAk4JPT = DQMStep1Analyzer("JetTester",
...
# AntiKt5 PF CHS jets
#-------------------------------------------------------------------------------
JetAnalyzerAk4PFCHS = DQMStep1Analyzer("JetTester",
                                  JetType = cms.untracked.string('pf'),
...
## AntiKt8 PF  jets
##-------------------------------------------------------------------------------
#JetAnalyzerAk8PF = DQMStep1Analyzer("JetTester",
#                                  JetType = cms.untracked.string('pf'),
#                                  OutputFile = cms.untracked.string(''),
...
## AntiKt8 PF CHS jets
##-------------------------------------------------------------------------------
#JetAnalyzerAk8PFCHS = DQMStep1Analyzer("JetTester",
#                                  JetType = cms.untracked.string('pf'),
#                                  OutputFile = cms.untracked.string(''),
...
## CA8 PF CHS jets
##-------------------------------------------------------------------------------
#JetAnalyzerCA8PFCHS = DQMStep1Analyzer("JetTester",
#                                  JetType = cms.untracked.string('pf'),
#                                  OutputFile = cms.untracked.string(''),
...
#                                  RThreshold                     = cms.double(0.3)
#                                  )
JetAnalyzerAk4PFCHSMiniAOD = DQMStep1Analyzer("JetTester",
...
JetAnalyzerAk4PFPUPPIMiniAOD = DQMStep1Analyzer("JetTester",
                                  JetType = cms.untracked.string('miniaod'),
...
JetAnalyzerAk8PFPUPPIMiniAOD = DQMStep1Analyzer("JetTester",
                                  JetType = cms.untracked.string('miniaod'),
