...
jetDQMAnalyzerAk4CaloUncleaned = DQMStep1Analyzer("JetAnalyzer",
...
jetDQMAnalyzerAkPU3Calo = DQMStep1Analyzer("JetAnalyzer_HeavyIons",
...
jetDQMAnalyzerAkPU3PF = DQMStep1Analyzer("JetAnalyzer_HeavyIons",
...
jetDQMAnalyzerAkCs3PF = DQMStep1Analyzer("JetAnalyzer_HeavyIons",
                                         JetType = cms.untracked.string('pf'),
...
jetDQMMatchAkPu3CaloAkPu3PF = DQMStep1Analyzer("JetAnalyzer_HeavyIons_matching",
...
jetDQMMatchAkPu4CaloAkPu4PF = DQMStep1Analyzer("JetAnalyzer_HeavyIons_matching",
...
jetDQMMatchAkPu5CaloAkPu5PF = DQMStep1Analyzer("JetAnalyzer_HeavyIons_matching",
