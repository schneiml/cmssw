...
if __name__ == "__main__":
    ...
    parser.add_argument("--steps", default="ALCA,ALCAOUTPUT,ALCAPRODUCER,ALCAHARVEST,DQM,HARVESTING,VALIDATION", help="Which workflow steps to inspect from runTheMatrix.")
