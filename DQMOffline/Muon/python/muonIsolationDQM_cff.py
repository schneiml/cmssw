...
MuIsoDQM_trk = DQMStep1Analyzer("MuonIsolationDQM",
...
MuIsoDQM_sta = DQMStep1Analyzer("MuonIsolationDQM",
                              Global_Muon_Label = cms.untracked.InputTag("muons"),
...
MuIsoDQM_glb = DQMStep1Analyzer("MuonIsolationDQM",
                              Global_Muon_Label = cms.untracked.InputTag("muons"),
                              requireTRKMuon = cms.untracked.bool(False),
                              requireSTAMuon = cms.untracked.bool(False),
...
MuIsoDQM_trk_miniAOD = DQMStep1Analyzer("MuonIsolationDQM",
...
MuIsoDQM_sta_miniAOD = DQMStep1Analyzer("MuonIsolationDQM",
                                      Global_Muon_Label = cms.untracked.InputTag("slimmedMuons"),
                                      requireTRKMuon = cms.untracked.bool(False),
                                      requireSTAMuon = cms.untracked.bool(True),
                                      requireGLBMuon = cms.untracked.bool(False),
...
MuIsoDQM_glb_miniAOD = DQMStep1Analyzer("MuonIsolationDQM",
                                      Global_Muon_Label = cms.untracked.InputTag("slimmedMuons"),
                                      requireTRKMuon = cms.untracked.bool(False),
                                      requireSTAMuon = cms.untracked.bool(False),
                                      requireGLBMuon = cms.untracked.bool(True),
