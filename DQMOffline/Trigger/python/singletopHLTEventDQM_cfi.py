...
SingleTopSingleMuonHLTOfflineDQM = DQMStep1Analyzer("TopSingleLeptonHLTOfflineDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
...
SingleTopSingleElectronHLTOfflineDQM = DQMStep1Analyzer("TopSingleLeptonHLTOfflineDQM",
