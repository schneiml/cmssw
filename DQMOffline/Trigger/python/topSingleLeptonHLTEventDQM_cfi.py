...
topSingleLeptonHLTOfflineDQM = DQMStep1Analyzer("TopSingleLeptonHLTOfflineDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
...
topSingleMuonHLTOfflineDQM = DQMStep1Analyzer("TopSingleLeptonHLTOfflineDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
  ## configuration of the MonitoringEnsemble(s)
...
topSingleElectronHLTOfflineDQM = DQMStep1Analyzer("TopSingleLeptonHLTOfflineDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
  ## configuration of the MonitoringEnsemble(s)
